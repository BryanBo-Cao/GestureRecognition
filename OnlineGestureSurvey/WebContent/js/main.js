...
//    alert("line 111");
//    var db = openDatabase('webcam');
//    alert("line 113");
//    db.transaction(function(tx) {
//    	tx.executeSql('INSERT INTO video (videodata) VALUES (blob);');
//    });
//    $.post("insert.jsp", blob);
    window.location = "localhost:8080/Webcam/insert.jsp";
//    window.location = "localhost:8080/Webcam/insert.jsp?videodatata=" + blob;
//    alert("line 118");
